...
def itemprocess(path):
	with open(path, "r") as f:
		...
		### 
		site_json = json.loads(soup.find("script", {"type": "application/ld+json"}, {"id": "release_schema"}).text)	
		...
		row = (rel_name, artists, label, date_pub, median, highest, lowest, last_sold, url)
		return row
